...
class GameSurface(ScreenHandle):
    ...
    def draw_hero(self):
        ...
        hero_x, hero_y = (self.game_engine.hero.position[0] - min_x, self.game_engine.hero.position[1] - min_y)
        self.blit(self.game_engine.hero.sprite, (hero_x * size, hero_y * size))
    ...
    def calculate(self):
        ...
        if hero_x < screen_x:
            ...
            hero_x = hero_x - screen_x

        if hero_y < screen_y:
            hero_y = 0
        else:
            hero_y = hero_y - screen_y
